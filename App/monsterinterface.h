#ifndef MONSTERINTERFACE_H
#define MONSTERINTERFACE_H
/*
...
这个宏有两个参数:
参数一:是接口类的名字，这里就是 MonsterInterface；
...
编译之后，如果使用了影子构建，你应该在于 GameSystem 文件夹平级处得到一个 build 文件夹，里面就是我们编译出的 GameSystem.exe （Windows）。
*/
#include <QtPlugin>
#include <QString>
